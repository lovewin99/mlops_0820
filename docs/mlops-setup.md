...
git add README.md docs .gitignore mlops_0820/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-2671584018168499.19.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-2671584018168499.19.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[mlops_0820/databricks.yml](../mlops_0820/databricks.yml) file.
...
Follow the instructions in [mlops_0820/resources/README.md](../mlops_0820/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_0820/resources/README.md)  to propose, test, and deploy
